    ...
    <area xsi:type="esdl:Area" id="4669ddca-3fda-4b2f-ad6a-442a7d54970a" name="Untitled Area">
      ...
      <asset xsi:type="esdl:HeatingDemand" name="HeatingDemand_Households" id="d8f0c97e-0a57-41fa-bd1c-b19662952901">
        <port xsi:type="esdl:InPort" name="In" carrier="5b28f3d6-4e34-4528-a304-0d1de417a1e4" id="ff3857c6-f562-4264-9956-bf91ecb2895f" connectedTo="d5a36dc8-4c1a-429f-b8a4-30f46266522f bbfafc2a-21df-43fd-a852-0eb260441fb4">
          <profile xsi:type="esdl:InfluxDBProfile" endDate="2016-01-01T00:00:00.000000+0100" id="51aa7ff4-faaf-42a2-a13c-d89cffce0839" filters="" measurement="nedu_aardgas_2015-2018" startDate="2015-01-01T00:00:00.000000+0100" port="8086" database="energy_profiles" field="G1A" multiplier="50.0" host="http://10.30.2.1">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="JOULE" id="eb07bccb-203f-407e-af98-e687656a221d" description="Energy in GJ" multiplier="GIGA" physicalQuantity="ENERGY"/>
          </profile>
        </port>
      ...
      <asset xsi:type="esdl:HeatPump" power="3000.0" efficiency="1.0" name="HeatPump_Local" id="63a497d2-9cd8-4b03-909b-9e48bebe0784" COP="3.0" controlStrategy="fb24d6f9-87a8-4196-b8c1-fece3953a644">
      ...
      <asset xsi:type="esdl:PVPark" surfaceArea="22287" name="PVPark_Local" id="e3ece454-2c6f-400e-abc4-aa0c6581338d">
        <port xsi:type="esdl:OutPort" name="Out" carrier="27e3b1ae-2a8b-46f2-b7d3-b5ec74ffe98c" id="61e3d061-b812-4966-9cc1-1c73d79232bb" connectedTo="679f16f5-b479-4fbe-a049-6d97fac73268">
          <profile xsi:type="esdl:InfluxDBProfile" endDate="2016-01-01T00:00:00.000000+0100" measurement="solar_relative_2011-2016" filters="" id="a1e96b6b-cf96-455b-9ec7-0816e9eb97ef" startDate="2015-01-01T00:00:00.000000+0100" port="8086" database="energy_profiles" field="value" multiplier="25.0" host="http://10.30.2.1">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="JOULE" id="eb07bccb-203f-407e-af98-e687656a221d" description="Energy in GJ" multiplier="GIGA" physicalQuantity="ENERGY"/>
          </profile>
        </port>
      ...
      <asset xsi:type="esdl:ElectricityNetwork" name="ElectricityNetwork_a6e9" id="a6e9adef-5e87-4c3d-99f9-162f60d05c25">
        ...
        <port xsi:type="esdl:OutPort" name="Out" carrier="27e3b1ae-2a8b-46f2-b7d3-b5ec74ffe98c" id="c742d07b-0761-4058-971e-cc7ac6938fc1" connectedTo="b8e720b7-6e8e-416d-aa1c-0bba76703bda 2366933b-f274-4de1-923a-65131203eab4"/>
      ...
      <asset xsi:type="esdl:Export" name="Export_Electricity_NW" id="897f883f-4a08-4b7c-9af0-ad154820a27c" power="10000.0">
        ...
        <costInformation xsi:type="esdl:CostInformation">
          <marginalCosts xsi:type="esdl:SingleValue" id="b15d9272-32c4-4f9e-9047-68ebe4684e36" value="0.01" name="Export_Electricity_NW-MarginalCosts"/>
        </costInformation>
